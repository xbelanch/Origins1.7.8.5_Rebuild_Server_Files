private["_itemType","_iPos","_indexLootSpawn","_iArray","_iItem","_iClass","_item","_qty","_max","_tQty","_arrayLootSpawn","_canType","_magsToS","_tQty","_indexLootSpawn","_canType"];
// [_itemType,_weights]
