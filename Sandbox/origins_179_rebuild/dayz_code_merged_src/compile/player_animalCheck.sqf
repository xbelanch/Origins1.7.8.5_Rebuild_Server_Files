private["_list","_Pos","_randrefpoint","_PosList","_PosSelect","_Pos","_list","_animalssupported","_type","_root","_favouritezones","_GroupMarker","_agent","_id","_tame","_dist"];
...
if (count _list < 1) then {
	...
	_animalssupported = ["Cow","Sheep","WildBoar","WildBoar","WildBoar","Goat","Goat","Goat"];
