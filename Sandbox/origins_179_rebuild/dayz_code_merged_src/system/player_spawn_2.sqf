...
// Add Info AlexSpain
	...
	_killsB = 		player getVariable["banditKills",0];	//Bandits	
	_headShots = 	player getVariable["headShots",0];		//Hero 
	_killsH = 		player getVariable["humanKills",0];		//Kepki
	_kills = 		player getVariable["zombieKills",0];	//Zombie
	_humanity =		player getVariable["humanity",0];
