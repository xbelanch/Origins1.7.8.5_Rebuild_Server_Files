...
if (isServer) then {
	_eh3 = _unit addEventHandler ["GetOut", {[(_this select 0),"all"] call server_updatObiect;}];
	_eh4 = _unit addEventHandler ["GetIn", {[(_this select 0),"all"] call server_updatObiect;}];
};