...
if (!isDedicated) then {
	...
	fnc_usec_damageActions =	compile preprocessFileLineNumbers "BASTARDS\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions =		compile preprocessFileLineNumbers "Debug\fn_selfActions.sqf";		//Checks which actions for self
	fnc_usec_unconscious =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_unconscious.sqf";
	player_temp_calculation	=	compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_temperatur.sqf";		//Temperatur System	//TeeChange
	player_weaponFiredNear =	compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_weaponFiredNear.sqf";
	player_animalCheck =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_animalCheck.sqf";
	player_spawnCheck =			compile preprocessFileLineNumbers "BASTARDS\player_spawnCheck.sqf";
	...
	player_reCin =				compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_reCin.sqf";
	player_tentPitch =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\tent_pitch.sqf";
	player_drink =				compile preprocessFileLineNumbers "BASTARDS\player_drink.sqf";
	player_eat =				compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_eat.sqf";
	player_useMeds =			compile preprocessFileLineNumbers "BASTARDS\player_useMeds.sqf";
	...
	onPreloadFinished {dayz_preloadFinished = true; onPreloadFinished {};};
	...
	// allow player disconnect from server, if loading hang, kicked by BE etc.
		...
		// 85 sec timeout
			...
			if ( !dayz_clientPreload ) then {
				...
				1 cutText ["Something went wrong, failed to verify player data, please re-connect without closing the game!", "PLAIN"];
...
//Both
	...
	fnc_usec_damageHandler =	compile preprocessFileLineNumbers "BASTARDS\fn_damageHandler.sqf";		//Event handler run on damage
	// Vehicle damage fix
	vehicle_handleDamage    = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\vehicle_handleDamage.sqf";
	vehicle_handleKilled    = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\vehicle_handleKilled.sqf";
	...
	local_zombieDamage = 		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_damageHandlerZ.sqf";	//Generated by the client who created a zombie to track damage, headshot only was removed.
	...
	player_medEpl =				compile preprocessFileLineNumbers "\z\addons\dayz_code\medical\publicEH\medEpl.sqf";
	...
	player_humanltyChange =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_humanltyChnge.sqf";
	spawn_loot =				compile preprocessFileLineNumbers "BASTARDS\spawn_loot.sqf";
